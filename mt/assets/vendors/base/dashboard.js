			...
			! function() {
				...
				function() {
					...
					function r(t, a, r) {
						var o = "",
							n = "";
						a - t < 100 || "今天是" == r ? (o = "今天是:", n = t.format("YYYY年MMMM月DD日")) : "昨天" == r ? (o = "昨天是", n = t.format("YYYY年MMMM月DD日")) : n = t.format("YYYY年MMMM月DD日") + " - " + a.format("YYYY年MMMM月DD日"), e.find(".m-subheader__daterange-date").html(n), e.find(".m-subheader__daterange-title").html(o)
					}
