			...
			if(0 !== t(this).length) {
				...
				var i = {
					...
					spinnerCallback: function(t) {
						if(t) {
							if(!i.isSpinning) {
								...
								!0 === e.message && (e.message = i.getOption("translate.records.processing")), i.isSpinning = !0, void 0 !== a && a.block(o, e)
							}
					...
					setActiveAll: function(e) {
						var a = t(o.table).find(".m-datatable__body .m-datatable__row").find('.m-datatable__cell--check .m-checkbox [type="checkbox"]');
